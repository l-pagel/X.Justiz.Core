...
<!-- 
    ...
    Version 1.5 (Änderungen: CR 24/047: Nachrichten dürfen nur eine Schutzschrift oder Rücknahme enthalten)
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" 
	...
	<!-- ZSSR - NACHRICHTEN -->
			...
			<!-- ZSSR - SGO-GESCHAEFTSREGELN: -->
				...
				<sch:pattern>
					<!-- Sonstige Pruefung: Es existiert genau ein Dokument mit 'GDS.Dokumenttyp.Typ3' - Codelisten-Eintrag '219|Schutzschrift' beim Element 'dokumententyp' und einem 'GDS.Dokumentklasse.Typ3' - Codelisten-Eintrag '015|Schreiben' beim Element 'dokumentklasse' (nicht Bereich 'akte'|'akte/teilakte', die jedoch auch nicht vorkommen duerfen!) (nur Nachricht: 2) -->
					<sch:rule context="tns:nachricht.zssr.einreichungSchutzschrift.2300002/tns:schriftgutobjekte">
						<sch:assert test="count(//tns:dokument[tns:xjustiz.fachspezifischeDaten/tns:dokumententyp/code = '219' and tns:xjustiz.fachspezifischeDaten/tns:dokumentklasse/code = '015']) = 1" id="SCH-ZSSR-0550">[SCH-ZSSR-0550] SGO: Es existiert nicht genau ein Dokument mit einem 'GDS.Dokumenttyp.Typ3' - Codelisten-Eintrag '219|Schutzschrift' beim Element 'dokumententyp' und einem 'GDS.Dokumentklasse.Typ3' - Codelisten-Eintrag '015|Schreiben' beim Element 'dokumentklasse'!</sch:assert>
					</sch:rule>
				</sch:pattern>
				...
				<sch:pattern>
					...
					<sch:rule context="tns:nachricht.zssr.ruecknahmeSchutzschrift.2300005/tns:schriftgutobjekte">
						<sch:assert test="count(//tns:dokument[tns:xjustiz.fachspezifischeDaten/tns:dokumententyp/code = '218' and tns:xjustiz.fachspezifischeDaten/tns:dokumentklasse/code = '015']) = 1" id="SCH-ZSSR-0555">[SCH-ZSSR-0555] SGO: Es existiert nicht genau ein Dokument mit einem 'GDS.Dokumenttyp.Typ3' - Codelisten-Eintrag '218|Rücknahme' beim Element 'dokumententyp' und einem 'GDS.Dokumentklasse.Typ3' - Codelisten-Eintrag '015|Schreiben' beim Element 'dokumentklasse'!</sch:assert>
					</sch:rule>
				</sch:pattern>
