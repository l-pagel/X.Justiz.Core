	...
	<!-- VSTR - NACHRICHTEN -->
		...
		<!-- VSTR - GRUNDDATEN-GESCHAEFTSREGELN: -->
			...
			<sch:pattern id="SCH-VSTR-0062" abstract="true">
				<!-- Kardinalitaet: Das 'auswahl_instanzbehoerde' - Element 'beteiligter' darf nicht vorkommen! (alle Nachrichten ausser Nachricht 5 und 8) -->
				<sch:rule context="$pfadNachrichtAlleOhne0508/tns:grunddaten/tns:verfahrensdaten/tns:instanzdaten/tns:auswahl_instanzbehoerde">
					<sch:assert test="count(tns:beteiligter) = 0">[SCH-VSTR-0062] Grunddaten: Das 'auswahl_instanzbehoerde' - Element 'beteiligter' darf nicht vorkommen!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				<!-- Kardinalitaet: Das optionale Element 'vorname' in 'vollerName' muss vorhanden sein! (alle Nachrichten ausser 0900008) -->
				<sch:rule context="//tns:beteiligter/tns:auswahl_beteiligter/tns:natuerlichePerson/tns:vollerName">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:vorname) = 1) else true()" id="SCH-VSTR-0110">[SCH-VSTR-0110] Grunddaten: Das optionale Element 'vorname' in 'vollerName' muss vorhanden sein!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				...
				<sch:rule context="//tns:beteiligter/tns:auswahl_beteiligter/tns:natuerlichePerson/tns:anschrift">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:anschriftstyp) = 1) else true()" id="SCH-VSTR-0140">[SCH-VSTR-0140] Grunddaten: Das optionale Element 'anschriftstyp' in 'anschrift' muss vorhanden sein!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				...
				<sch:rule context="//tns:beteiligter/tns:auswahl_beteiligter/tns:natuerlichePerson/tns:anschrift">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:anschriftenzusatz) &lt; 2) else true()" id="SCH-VSTR-0145">[SCH-VSTR-0145] Grunddaten: Das optionale Element 'anschriftenzusatz' in 'anschrift' darf höchstens einmal vorkommen!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				...
				<sch:rule context="//tns:beteiligter/tns:auswahl_beteiligter/tns:natuerlichePerson/tns:anschrift">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:strasse) = 1) else true()" id="SCH-VSTR-0150">[SCH-VSTR-0150] Grunddaten: Das optionale Element 'strasse' in 'anschrift' muss vorhanden sein!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				...
				<sch:rule context="//tns:beteiligter/tns:auswahl_beteiligter/tns:natuerlichePerson/tns:anschrift">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:hausnummer) = 1) else true()" id="SCH-VSTR-0155">[SCH-VSTR-0155] Grunddaten: Das optionale Element 'hausnummer' in 'anschrift' muss vorhanden sein!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				...
				<sch:rule context="//tns:beteiligter/tns:auswahl_beteiligter/tns:natuerlichePerson/tns:anschrift">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:postleitzahl) = 1) else true()" id="SCH-VSTR-0160">[SCH-VSTR-0160] Grunddaten: Das optionale Element 'postleitzahl' in 'anschrift' muss vorhanden sein!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				...
				<sch:rule context="//tns:beteiligter/tns:auswahl_beteiligter/tns:natuerlichePerson/tns:anschrift">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:ort) = 1) else true()" id="SCH-VSTR-0165">[SCH-VSTR-0165] Grunddaten: Das optionale Element 'ort' in 'anschrift' muss vorhanden sein!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				...
				<sch:rule context="//tns:beteiligter/tns:auswahl_beteiligter/tns:organisation/tns:anschrift">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:anschriftstyp) = 1) else true()" id="SCH-VSTR-0210">[SCH-VSTR-0210] Grunddaten: Das optionale Element 'anschriftstyp' in 'anschrift' muss vorhanden sein!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				...
				<sch:rule context="//tns:beteiligter/tns:auswahl_beteiligter/tns:organisation/tns:anschrift">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:anschriftenzusatz) &lt; 2) else true()" id="SCH-VSTR-0215">[SCH-VSTR-0215] Grunddaten: Das optionale Element 'anschriftenzusatz' in 'anschrift' darf höchstens einmal vorkommen!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				...
				<sch:rule context="//tns:beteiligter/tns:auswahl_beteiligter/tns:organisation/tns:anschrift">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:strasse) = 1) else true()" id="SCH-VSTR-0220">[SCH-VSTR-0220] Grunddaten: Das optionale Element 'strasse' in 'anschrift' muss vorhanden sein!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				...
				<sch:rule context="//tns:beteiligter/tns:auswahl_beteiligter/tns:organisation/tns:anschrift">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:hausnummer) = 1) else true()" id="SCH-VSTR-0225">[SCH-VSTR-0225] Grunddaten: Das optionale Element 'hausnummer' in 'anschrift' muss vorhanden sein!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				...
				<sch:rule context="//tns:beteiligter/tns:auswahl_beteiligter/tns:organisation/tns:anschrift">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:postleitzahl) = 1) else true()" id="SCH-VSTR-0230">[SCH-VSTR-0230] Grunddaten: Das optionale Element 'postleitzahl' in 'anschrift' muss vorhanden sein!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				...
				<sch:rule context="//tns:beteiligter/tns:auswahl_beteiligter/tns:organisation/tns:anschrift">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:ort) = 1) else true()" id="SCH-VSTR-0235">[SCH-VSTR-0235] Grunddaten: Das optionale Element 'ort' in 'anschrift' muss vorhanden sein!</sch:assert>
				</sch:rule>
			</sch:pattern>
	
			<sch:pattern>
				<!-- Kardinalitaet: Das Element 'auswahl_termin' darf nicht vorkommen (alle Nachrichten ausser 0900008) -->
				<sch:rule context="//tns:grunddaten/tns:verfahrensdaten">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:auswahl_termin) = 0) else true()" id="SCH-VSTR-0300">[SCH-VSTR-0300] Grunddaten: Das Element 'auswahl_termin' darf nicht vorkommen!</sch:assert>
				</sch:rule>
			</sch:pattern>
			<!-- /Individuelle Rules -->
		...
		<!-- VSTR - CODELISTEN-GESCHAEFTSREGELN: -->
			...
			<sch:pattern>
				...
				<sch:rule context="//tns:beteiligung/tns:rolle/tns:rollenbezeichnung">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then code = '143' else true()" id="SCH-VSTR-0520">[SCH-VSTR-0520] Codeliste: Der Codelistenschlüssel der Typ1-Codeliste 'GDS.Rollenbezeichnung' zum Element 'rollenbezeichnung' darf nur den folgenden Wert haben:'143'!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				<!-- Eingeschraenkte Werteliste zur Codeliste 'GDS.Registerart'; nur Schlüssel|Wert 'GnR|Genossenschaftsregister (AG)', 'HRA|Handelsregister (Einzelkaufleute, Personengesellschaften) (AG)', 'HRB|Handelsregister (Kapitalgesellschaften) (AG)', 'PR|Partnerschaftsregister (AG)' und 'VR|Vereinsregister' (alle Nachrichten ausser 0900008) -->
				<sch:rule context="//tns:registerart">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then code = ('GnR','HRA','HRB','PR','VR') else true()" id="SCH-VSTR-0535">[SCH-VSTR-0535] Codeliste: Der Codelistenschlüssel der Typ1-Codeliste 'GDS.Registerart' zum Element 'registerart' darf nur folgende Werte haben:'GnR','HRA','HRB','PR' oder 'VR'!</sch:assert>
				</sch:rule>
			</sch:pattern>
			
			<!-- 'Code.GDS.Rechtsform' -->
			<sch:pattern>
				<!-- Eingeschraenkte Werteliste zur Codeliste 'GDS.Rechtsform'; Schlüssel|Wert 'Freitext|siehe weitere Bezeichnung' darf nicht vorkommen (alle Nachrichten ausser 0900008) -->
				<sch:rule context="//tns:beteiligung/tns:beteiligter/tns:auswahl_beteiligter/tns:organisation/tns:angabenZurRechtsform/tns:rechtsform">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then not(code = 'Freitext') else true()" id="SCH-VSTR-0540">[SCH-VSTR-0540] Codeliste: Der Codelistenschlüssel der Typ3-Codeliste 'GDS.Rechtsform' zum Element 'rechtsform' (unterhalb von 'angabenZurRechtsform' in 'organisation') darf nicht den folgenden Wert haben:'Freitext'!</sch:assert>
				</sch:rule>
			</sch:pattern>
