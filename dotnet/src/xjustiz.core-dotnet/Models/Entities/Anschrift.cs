...
public class Anschrift
{
    ...
    /// </summary>
    [XmlElement("strasse", Namespace = SchemaConstants.XJustiz_Tns, Order = 1)]
    [XJustizAvailability(XJustizVersion.V2_1_0)]
    [XJustizCoreAvailability(XJustizCoreVersion.V0_2_0)]
    ...
    /// </summary>
    [XmlElement("hausnummer", Namespace = SchemaConstants.XJustiz_Tns, Order = 2)]
    [XJustizAvailability(XJustizVersion.V2_1_0)]
    [XJustizCoreAvailability(XJustizCoreVersion.V0_2_0)]
    ...
    /// </summary>
    [XmlElement("postleitzahl", Namespace = SchemaConstants.XJustiz_Tns, Order = 3)]
    [XJustizAvailability(XJustizVersion.V2_1_0)]
    [XJustizCoreAvailability(XJustizCoreVersion.V0_2_0)]
    ...
    /// </summary>
    [XmlElement("ort", Namespace = SchemaConstants.XJustiz_Tns, Order = 4)]
    [XJustizAvailability(XJustizVersion.V2_1_0)]
    [XJustizCoreAvailability(XJustizCoreVersion.V0_2_0)]
    ...
    /// </summary>
    [XmlElement("staat", Namespace = SchemaConstants.XJustiz_Tns, Order = 5)]
    [XJustizAvailability(XJustizVersion.V2_1_0)]
    [XJustizCoreAvailability(XJustizCoreVersion.V0_2_0)]
