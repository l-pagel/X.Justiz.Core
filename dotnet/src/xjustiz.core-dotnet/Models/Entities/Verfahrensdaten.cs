...
public class Verfahrensdaten
{
    ...
    /// </summary>
    [XmlElement("verfahrensnummer", Namespace = SchemaConstants.XJustiz_Tns, Order = 1)]
    [XJustizAvailability(XJustizVersion.V2_1_0)]
    [XJustizCoreAvailability(XJustizCoreVersion.V0_2_0)]
    ...
    /// </summary>
    [XmlElement("instanzdaten", Namespace = SchemaConstants.XJustiz_Tns, Order = 2)]
    [XJustizAvailability(XJustizVersion.V2_1_0)]
    [XJustizCoreAvailability(XJustizCoreVersion.V0_2_0)]
    ...
    /// </summary>
    [XmlElement("beteiligung", Namespace = SchemaConstants.XJustiz_Tns, Order = 3)]
    [XJustizAvailability(XJustizVersion.V2_1_0)]
    [XJustizCoreAvailability(XJustizCoreVersion.V0_2_0)]
