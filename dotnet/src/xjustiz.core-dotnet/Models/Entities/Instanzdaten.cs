...
public class Instanzdaten
{
    ...
    /// </summary>
    [XmlElement("instanznummer", Namespace = SchemaConstants.XJustiz_Tns, Order = 1)]
    [XJustizAvailability(XJustizVersion.V3_1_1)]
    [XJustizCoreAvailability(XJustizCoreVersion.V0_2_0)]
    ...
    /// </summary>
    [XmlElement("sachgebietszusatz", Namespace = SchemaConstants.XJustiz_Tns, Order = 2)]
    [XJustizAvailability(XJustizVersion.V3_1_1)]
    [XJustizCoreAvailability(XJustizCoreVersion.V0_2_0)]
    ...
    /// </summary>
    [XmlElement("auswahl_instanzbehoerde", Namespace = SchemaConstants.XJustiz_Tns, Order = 3)]
    [XJustizAvailability(XJustizVersion.V3_1_1)]
    [XJustizCoreAvailability(XJustizCoreVersion.V0_2_0)]
