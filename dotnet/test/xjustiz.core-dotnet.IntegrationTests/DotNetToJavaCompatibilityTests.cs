// <copyright file="DotNetToJavaCompatibilityTests.cs" company="PlaceholderCompany">
...
public class DotNetToJavaCompatibilityTests(IntegrationTestFixture fixture)
{
    ...
    public async Task DotNetToJava_HttpJson_ShouldPreserveAllData(TestDataProvider.Dataset dataset)
    {
        ...
        var jsonFromJava = await fixture.Client.SendJsonHttpAsync(IntegrationTestFixture.JavaApiUrl, messageFromDotNet);
    ...
    public async Task DotNetToJava_JsonFile_RoundTrip_ShouldPreserveData(TestDataProvider.Dataset dataset)
    {
        ...
        _ = await fixture.Client.SendJsonFileAsync(IntegrationTestFixture.JavaApiUrl, jsonFromDotNet);
