// <copyright file="FullRoundTripCompatibilityTests.cs" company="X.Justiz Core">
...
public class FullRoundTripCompatibilityTests
{
    private readonly IntegrationTestFixture fixture;

    public FullRoundTripCompatibilityTests(IntegrationTestFixture fixture)
    {
        this.fixture = fixture;
    }

    #region Full Round-Trip Tests (Source → Target → Source)
    ...
    #region Mixed Format Round-Trip Tests
