 ...
 * <p>
 * <u><b>Subject-specific data of a file:</b></u> Specialized data of a
 * file/case.
 */
...
public class XjustizAkteFachspezifischeDaten {
    ...
    /**
     * Bezeichnet den Aktentyp anhand der vorgegebenen Werteliste. Diese ist für
     * einen reibungslosen Austausch bewusst knappgehalten. Für eine spezifischere
     * Bezeichnung kann das Feld "anzeigename" verwendet werden.
     * <p>
     * <u><b>File type:</b></u> Designates the file type based on the predefined
     * value list. This is deliberately kept concise for smooth exchange. For a more
     * specific designation, the field 'anzeigename' (display name) can be used.
     */
    ...
    /**
     * Der Anzeigename ermöglicht als Freitext die Übermittlung der Bezeichnung der
     * Akte, wie sie im versendenden System angezeigt wird, bspw. als
     * <a href='https://de.wikipedia.org/wiki/Rubrum'>Rubrum</a> (Max Muster ./.
     * Sabine Schmidt).
     * <p>
     * <u><b>Display name:</b></u> The display name allows the transmission of the
     * designation of the file as it is displayed in the sending system as free
     * text, e.g. as <a href='https://de.wikipedia.org/wiki/Rubrum'>Rubrum</a> (Max
     * Muster ./. Sabine Schmidt).
     */
    ...
    /**
     * Hier steht das Aktenzeichen, unter dem die Station (siehe oben) das Verfahren
     * führt.
     * <p>
     * <u><b>File reference:</b></u> Here is the file reference under which the
     * station (see above) conducts the proceeding.
     */
