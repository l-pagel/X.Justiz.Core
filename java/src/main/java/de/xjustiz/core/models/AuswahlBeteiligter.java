...
public class AuswahlBeteiligter {
    ...
    /**
     * Hier werden alle Beteiligten aufgeführt, die nicht mit dem
     * Type.GDS.NatuerlichePerson abgedeckt werden können: Gesellschaften, Vereine,
     * Bruchteilsgemeinschaften etc. Die Abgrenzung erfolgt nicht nach juristischen
     * Kategorien, sondern nach datentechnischer Zweckmäßigkeit.
     * <p>
     * <u><b>Organization:</b></u> All participants who cannot be covered by
     * Type.GDS.NatuerlichePerson are listed here: companies, associations,
     * fractional communities, etc. The distinction is not based on legal categories
     * but on data technical expediency.
     */
