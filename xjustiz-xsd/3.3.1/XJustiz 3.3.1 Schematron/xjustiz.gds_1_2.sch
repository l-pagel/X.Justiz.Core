...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" 
	...
	<!-- GDS - CODELISTEN-GESCHAEFTSREGELN: -->
		...
		<!-- Individuelle Rules -->
			...
			<sch:pattern>
					<!-- Fester Codelistenwert: Das Nachrichtenkopf-Element 'vertraulichkeitsstufe' muss den Schlüsselwert '002' (für 'sensibel') haben, da mindestens in einem Schriftgutobjekt diese Vertraulichkeitsstufe verwendet wird und in keinem Schriftgutobjekt die strengere Vertraulichkeitsstufe '001' (für 'VS - NUR FÜR DEN DIENSTGEBRAUCH') verwendet wird!-->
					<sch:rule context="//tns:nachrichtenkopf">
