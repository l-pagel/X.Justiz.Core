...
<!-- 
    ...
    Version 1.0.4 (Oktober 2023; Aenderung zu: SCH-VAG-0200 (Fehlerausgabetext hinsichtlich geaendertem Codelistendatentyp zu 'GDS.Rollenbezeichnung.Typ3' (zuvor Typ1) angepasst))
			...
			<!-- Individuelle Rules -->
				...
				<sch:pattern>
					...
					<sch:rule context="//tns:beteiligung/tns:rolle/tns:rollenbezeichnung">
						<sch:assert test="code = ('015','016','181')" id="SCH-VAG-0200">[SCH-VAG-0200] Codeliste: Der Codelistenschlüssel der Typ3-Codeliste 'GDS.Rollenbezeichnung' zum Element 'rollenbezeichnung' darf nur folgende Werte haben:'015','016' oder '181'!</sch:assert>
					</sch:rule>
				</sch:pattern>
