...
<!-- 
    ...
    XJustiz-Fachmodul xjustiz_0500_straf_3_4.xsd
    Version 1.1 für XJustiz 3.4
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2"
    ...
    <sch:pattern>
        ...
        <sch:rule id="rule-SCH-STRAF-0001" abstract="true">
            <sch:assert id="SCH-STRAF-0001" test="exists(tns:art)">
        ...
        <sch:rule context="tns:nachricht.straf.ermittlungsErkenntnisverfahren.0500001//tns:erledigung">
            <sch:extends rule="rule-SCH-STRAF-0001"/>
        </sch:rule>
