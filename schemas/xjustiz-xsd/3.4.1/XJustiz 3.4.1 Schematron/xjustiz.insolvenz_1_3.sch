...
<!-- 
    Schematron-Schema zur Prüfung von Geschäftsregeln
    für XJustiz 3.4.1, Fachdatensatz Insolvenz (xjustiz_0300_insolvenz_3_3.xsd)
    Version 1.3: Regel SCH-INSO-0027 wurde hinzugefügt.
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2"
    ...
    <!-- Geschäftsregeln für alle Nachrichten 0300xxx -->
    <sch:pattern>
        <sch:rule context="//tns:auswahl_registerbehoerde">
            <sch:assert test="not(exists(tns:auslaendischeRegisterbehoerde))" id="SCH-INSO-0027">
                [SCH-INSO-0027] Grunddaten: Das 'auswahl_registerbehoerde'-Element 'auslaendischeRegisterbehoerde' darf nicht vorkommen.
            </sch:assert>
        </sch:rule>
    </sch:pattern>
