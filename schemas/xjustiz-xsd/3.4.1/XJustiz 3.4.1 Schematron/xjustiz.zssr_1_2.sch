...
<!-- 
    ...
    Version 1.2.2 (Oktober 2022; Korrekturen¹/Optimierungen²/Änderungen³ zu: SCH-ZSSR-0003 bis SCH-ZSSR-0010 und SCH-ZSSR-0080 bis SCH-ZSSR-0225 (jeweils Lokalisierungszusatz entfallen)², SCH-ZSSR-0005³, SCH-ZSSR-0020¹, SCH-ZSSR-0051/0052², SCH-ZSSR-0070³, SCH-ZSSR-0504³, SCH-ZSSR-0550/0555²³, SCH-ZSSR-0560³; Neu: SCH-ZSSR-0235, SCH-ZSSR-0240, SCH-ZSSR-0245, SCH-ZSSR-0250, SCH-ZSSR-0255, SCH-ZSSR-0260, SCH-ZSSR-0529, SCH-ZSSR-0565, SCH-ZSSR-0600, SCH-ZSSR-0605)
	...
	<!-- ZSSR - NACHRICHTEN -->
			...
			<!-- ZSSR - GRUNDDATEN-GESCHAEFTSREGELN: -->
				...
				<!-- Abstrakte Pattern -->
					...
					<sch:pattern id="SCH-ZSSR-0004" abstract="true">
						<!-- Pattern: Eine deutsche Postleitzahl muss folgende Bedingungen erfüllen: 5 Ziffern, nur Ziffern, PLZ größer als '00999' (nur Nachricht: 2) -->
						<sch:rule context="$pfadNachricht2300002/tns:postleitzahl"> 
							...
							<!-- alternativ, soweit von Schematron-Validator unterstützt: <sch:assert test="matches(., '^(?!00)\d{5}$', 'i;j')">[SCH-ZSSR-0004] Grunddaten: Eine deutsche Postleitzahl muss folgende Bedingungen erfüllen: 5 Ziffern, nur Ziffern, PLZ größer als '00999'!</sch:assert> -->
						</sch:rule>
					</sch:pattern>
					
					<sch:pattern id="SCH-ZSSR-0005" abstract="true">
						<!-- Pattern: Das Element 'ort' darf max. 26 Zeichen haben und muss mit einem Großbuchstaben der 'DIN SPEC 91379 Datentyp B' beginnen! (Nicht notwendigerweise nur von A bis Z - auch auslaendisch, wie z.B. Ø (skandinavisch) erlaubt!) (nur Nachricht: 2) -->
					...
					<sch:pattern id="SCH-ZSSR-0007" abstract="true">
						...
						<sch:rule context="$pfadNachricht2300002/tns:titel">
							<sch:assert test="matches(., '^.{1,25}$')">[SCH-ZSSR-0007] Grunddaten: Das Element 'titel' darf max. 25 Zeichen haben!</sch:assert>
						</sch:rule>
					</sch:pattern>
					...
					<sch:pattern id="SCH-ZSSR-0009" abstract="true">
						...
						<sch:rule context="$pfadNachricht2300002/tns:rufname">
							<sch:assert test="matches(., '^.{1,35}$')">[SCH-ZSSR-0009] Grunddaten: Das Element 'rufname' darf max. 35 Zeichen haben!</sch:assert>
						</sch:rule>
					</sch:pattern>
				...
				<!-- Individuelle Rules -->
					...
					<sch:pattern>
						<!-- Kardinalitaet: Das Element 'beteiligung' muss mind. zweimal vorkommen (nur Nachricht: 2) -->
						<sch:rule context="tns:nachricht.zssr.einreichungSchutzschrift.2300002/tns:grunddaten/tns:verfahrensdaten">
					...
					<sch:pattern>
						<!-- Kardinalitaet: Es muss mind. ein Antragssteller als Beteiligter (aus der Codeliste 'GDS.Rollenbezeichnung', Schlüssel: 016) vorhanden sein (nur Nachricht: 2) -->
						<sch:rule context="tns:nachricht.zssr.einreichungSchutzschrift.2300002/tns:grunddaten/tns:verfahrensdaten">
							<sch:assert test="count(tns:beteiligung[tns:rolle/tns:rollenbezeichnung/code = '016']) &gt; 0" id="SCH-ZSSR-0051">[SCH-ZSSR-0051] Grunddaten: Es muss mind. ein Beteiligter in der Rolle des Antragssteller (Codeliste 'GDS.Rollenbezeichnung', Schlüssel: 016) vorhanden sein!</sch:assert>
						</sch:rule>
					</sch:pattern>
					
					<sch:pattern>
						<!-- Kardinalitaet: Es muss mind. ein Antragsgegner als Beteiligter (aus der Codeliste 'GDS.Rollenbezeichnung', Schlüssel: 015) vorhanden sein (nur Nachricht: 2) -->
						<sch:rule context="tns:nachricht.zssr.einreichungSchutzschrift.2300002/tns:grunddaten/tns:verfahrensdaten">
				...
				<sch:pattern id="SCH-ZSSR-0230" abstract="true">
					<!-- Sicherstellung des neuen 'DESTATIS-BEV-Code' - Codes gemäß Codeliste 'BfJ Staat' zu den Elementen 'staat' ('ausstellenderStaat', 'staatsangehoerigkeit', 'herkunftsland'):  genau 3 Ziffern, nur Ziffern (numerisch) (nur Nachrichten: 2, 4) -->
				...
				<sch:pattern is-a="SCH-ZSSR-0230">
					<!-- Sicherstellung des neuen 'DESTATIS-BEV-Code' - Codes gemäß Codeliste 'BfJ Staat' zu den Elementen 'staat' ('ausstellenderStaat', 'staatsangehoerigkeit', 'herkunftsland'):  genau 3 Ziffern, nur Ziffern (numerisch) -->
				...
				<sch:pattern>
					<!-- Zuweisung des Prozessbevollmächtigten: Das Element '//grunddaten/verfahrensdaten/beteiligung/rolle' mit der Rollenbezeichnung ('/rollenbezeichnung') '132|Prozessbevollmächtigter' muss das Kindelement '/referenz/ref.rollennummer' aufweisen (nur Nachricht: 2) -->
					<sch:rule context="tns:nachricht.zssr.einreichungSchutzschrift.2300002/tns:grunddaten/tns:verfahrensdaten/tns:beteiligung/tns:rolle">
				...
				<sch:pattern>
					<!-- Auflösung der Referenzen zwischen Rollen: Das Element '//tns:grunddaten/tns:verfahrensdaten/tns:beteiligung/tns:rolle/tns:referenz/tns:ref.rollennummer' muss in seinem Wert dem Element '/tns:rollennummer' eines anderen Elternelements '//tns:grunddaten/tns:verfahrensdaten/tns:beteiligung/tns:rolle' entsprechen (nur Nachricht: 2) -->
					<sch:rule context="tns:nachricht.zssr.einreichungSchutzschrift.2300002/tns:grunddaten/tns:verfahrensdaten/tns:beteiligung/tns:rolle/tns:referenz/tns:ref.rollennummer">
						<sch:assert test="exists(//tns:rolle[tns:rollennummer=current() and not(current()/../../tns:rollennummer=current())])" id="SCH-ZSSR-0250">[SCH-ZSSR-0250] Grunddaten: Der Wert zum Element '/tns:grunddaten/tns:verfahrensdaten/tns:beteiligung/tns:rolle/tns:referenz/tns:ref.rollennummer' entspricht mit seinem Wert nicht dem Element '/tns:rollennummer' eines anderen Elternelements '/tns:grunddaten/tns:verfahrensdaten/tns:beteiligung/tns:rolle'!</sch:assert>
					</sch:rule>
				</sch:pattern>
				...
				<sch:pattern>
					<!-- Sofern Elemente '/grunddaten/verfahrensdaten/beteiligung/rolle' mit der Rollenbezeichnung ('/rollenbezeichnung') '132|Prozessbevollmächtigter' existieren: Genau ein erster Prozessbevollmächtigter: Es muss genau ein Element '//grunddaten/verfahrensdaten/beteiligung/rolle' mit der Rollenbezeichnung ('/rollenbezeichnung') '132|Prozessbevollmächtigter' geben, dessen Kindelement '/nr' den Wert '1' aufweist bzw. nicht definiert ist, was auf Grund des Default-Werts ebenfalls '1' entspricht (nur Nachricht: 2) -->
					<sch:rule context="tns:nachricht.zssr.einreichungSchutzschrift.2300002/tns:grunddaten/tns:verfahrensdaten">
			...
			<!-- ZSSR - SGO-GESCHAEFTSREGELN: -->
				...
				<sch:pattern id="SCH-ZSSR-0525" abstract="true">
					<!-- Sonstige Prüfung: Der Dateiname (welcher auch das Dateiformat und den Punkt als Trennzeichen enthält) darf die zulässige Anzahl von 90 Zeichen nicht überschritten (nur Nachrichten: 2, 5) -->
				...
				<sch:pattern id="SCH-ZSSR-0526" abstract="true">
					<!-- Sonstige Prüfung: SGO: Der Dateiname (hier 'dateiname.bezugsdatei', welcher auch das tatsächliche Dateiformat und den Punkt als Trennzeichen enthält) darf die zulässige Zeichenanzahl von 90 nicht überschreiten (nur Nachrichten: 2, 5) -->
					<!-- Hier wird angegeben: 'Dateiname.DateiformatImKlartext' (Beispiel: Schutzschrift.pdf) -->
				...
				<sch:pattern>
					<!-- Sonstige Prüfung: Es existiert mind. ein Dokument mit 'GDS.Dokumenttyp.Typ3' - Codelisten-Eintrag '219|Schutzschrift' beim Element 'dokumententyp' und einem 'GDS.Dokumentklasse.Typ3' - Codelisten-Eintrag '015|Schreiben' beim Element 'dokumentklasse' (nicht Bereich 'akte'|'akte/teilakte', die jedoch auch nicht vorkommen dürfen!) (nur Nachricht: 2) -->
					<sch:rule context="tns:nachricht.zssr.einreichungSchutzschrift.2300002/tns:schriftgutobjekte">
				...
				<sch:pattern>
					 <!--Sonstige Prüfung: nur für 'tns:schriftgutobjekte/tns:dokument' und nicht für 'tns:schriftgutobjekte/tns:akte/.../tns:dokument'! In einem Element 'dokument' (A) verweist ein Unterelement 'datei' (A) [Kardinalität: 1..n] mit dem weiteren Unterelement 'dateiname.bezugsdatei' [Kardinalität: 0..n] per Wert in demselben(!) 'dokument' (A) auf das im  weiteren Unterelement 'datei'(B) zwingend vorhandene, weitere Unterelement 'dateiname' als Bezugsdatei. Dieser referenzierte Instanz-Knoten 'dateiname' muss den gleichen Wert haben, wie 'dateiname.bezugsdatei' aus 'dokument' (A)! 
					 ...
					 Achtung: Wenn Element 'dateiname.bezugsdatei' (mehrfaches Vorkommen möglich!) befüllt ist, muss dort (wie auch beim Element 'dateiname') immer ein Dateiformat mit einem vorangestellten Punkt mit angegeben werden (z.B.: '.pdf' - also insgesamt z.B. 'Schutzschrift.pdf')! (alle Nachrichten)  --> 
				...
				<sch:pattern>
					<!-- Sonstige Prüfung: Schriftgutobjekte dürfen lediglich Dokumente und keine Akten enthalten! (alle Nachrichten) -->
			...
			<!-- ZSSR - FACHDATEN-GESCHAEFTSREGELN: -->
				...
				<sch:pattern>
					<!-- Angabe des Rücknahmecodes: Das Element '//fachdaten/verfahrensdaten/ruecknahmecode' darf nicht leer sein (nur Nachricht: 5) -->
					<sch:rule context="tns:nachricht.zssr.ruecknahmeSchutzschrift.2300005/tns:fachdaten/tns:verfahrensdaten">
