...
<!-- 
    Schematron-Schema zur Prüfung von Geschäftsregeln für den XJustiz-Fachdatensatz VSTR
    Version 1.9: Bugfix der Regel SCH-VSTR-0008 (für XJustiz ab Version 3.6.2)
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" 
	...
	<!-- VSTR - NACHRICHTEN -->
		...
		<!-- VSTR - NACHRICHTENKOPF-GESCHAEFTSREGELN: -->
			...
			<!-- Abstrakte Rules -->
			<sch:pattern>
				<!-- Kardinalitaet: Das Element 'aktenzeichen' des Absenders muss genau einmal vorkommen -->
				<sch:rule id="SCH-VSTR-0001" abstract="true">
					<sch:assert test="count(tns:absender/tns:aktenzeichen) = 1" >[SCH-VSTR-0001] Nachrichtenkopf: Das Element 'aktenzeichen'  in der Sequenz 'absender' muss genau einmal vorkommen!</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<!-- Individuelle Rules -->
			<sch:pattern>
				<!-- Kardinalitaet: 'rvTraeger' darf nicht als Absender vorkommen (alle Nachrichten ausser 0900008) -->
				<sch:rule context="//tns:nachrichtenkopf/tns:absender/tns:informationen/tns:auswahl_kommunikationspartner">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:rvTraeger) = 0) else true()" id="SCH-VSTR-0005">
						[SCH-VSTR-0005] Nachrichtenkopf: Das 'auswahl_kommunikationspartner'–Element 'rvTraeger' unter absender/informationen darf nicht vorkommen!
					</sch:assert>
				</sch:rule>
			</sch:pattern>
			
			<sch:pattern>
				<!-- Kardinalitaet: 'gericht' darf nicht als Absender vorkommen (nur Nachricht 5) -->
				<sch:rule context="tns:nachricht.vstr.schuldnerverzeichnis.abdrucke.0900005/tns:nachrichtenkopf/tns:absender/tns:informationen/tns:auswahl_kommunikationspartner">
					<sch:assert test="count(tns:gericht) = 0" id="SCH-VSTR-0006">
						[SCH-VSTR-0006] Nachrichtenkopf: Das 'auswahl_kommunikationspartner'-Element 'gericht' unter absender/informationen darf nicht vorkommen!
					</sch:assert>
				</sch:rule>
			</sch:pattern>
			
			<sch:pattern>
				<!-- Kardinalitaet: 'polizeibehoerde' darf nicht als Absender vorkommen (alle Nachrichten ausser 0900008) -->
				<sch:rule context="//tns:nachrichtenkopf/tns:absender/tns:informationen/tns:auswahl_kommunikationspartner">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:polizeibehoerde) = 0) else true()" id="SCH-VSTR-0007">
						[SCH-VSTR-0007] Nachrichtenkopf: Das 'auswahl_kommunikationspartner'-Element 'polizeibehoerde' unter absender/informationen darf nicht vorkommen!
					</sch:assert>
				</sch:rule>
			</sch:pattern>
				
			<sch:pattern>
				<!-- Kardinalitaet: 'finanzbehoerde' darf nicht als Absender vorkommen (alle Nachrichten ausser 0900008) -->
				<sch:rule context="//tns:nachrichtenkopf/tns:absender/tns:informationen/tns:auswahl_kommunikationspartner">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:finanzbehoerde) = 0) else true()" id="SCH-VSTR-0008">
						[SCH-VSTR-0008] Nachrichtenkopf: Das 'auswahl_kommunikationspartner'-Element 'finanzbehoerde' unter absender/informationen darf nicht vorkommen!
					</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				<!-- Kardinalitaet: 'rvTraeger' darf nicht als Empfänger vorkommen (alle Nachrichten ausser 0900008) -->
				<sch:rule context="//tns:nachrichtenkopf/tns:empfaenger/tns:informationen/tns:auswahl_kommunikationspartner">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:rvTraeger) = 0) else true()" id="SCH-VSTR-0010">
						[SCH-VSTR-0010] Nachrichtenkopf: Das 'auswahl_kommunikationspartner'-Element 'rvTraeger' unter empfaenger/informationen darf nicht vorkommen!
					</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern id="SCH-VSTR-0011" abstract="true">
				<!-- Kardinalitaet: 'sonstige' darf nicht als Empfänger vorkommen (Nachrichten 1, 2, 3, 6) -->
				<sch:rule context="$pfadNachrichtAlleOhne04050708/tns:nachrichtenkopf/tns:empfaenger/tns:informationen/tns:auswahl_kommunikationspartner">
					<sch:assert test="count(tns:sonstige) = 0">
						[SCH-VSTR-0011] Nachrichtenkopf: Das 'auswahl_kommunikationspartner'-Element 'sonstige' unter empfaenger/informationen darf nicht vorkommen!
					</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<!-- Individuelle Rules -->
			<sch:pattern>
				<!-- Kardinalitaet: 'gericht' darf nicht als Empfänger vorkommen (nur Nachricht 5) -->
				<sch:rule context="tns:nachricht.vstr.schuldnerverzeichnis.abdrucke.0900005/tns:nachrichtenkopf/tns:empfaenger/tns:informationen/tns:auswahl_kommunikationspartner">
					<sch:assert test="count(tns:gericht) = 0" id="SCH-VSTR-0015">
						[SCH-VSTR-0015] Nachrichtenkopf: Das 'auswahl_kommunikationspartner'-Element 'gericht' unter empfaenger/informationen darf nicht vorkommen!
					</sch:assert>
				</sch:rule>
			</sch:pattern>
			
			<sch:pattern>
				<!-- Kardinalitaet: 'polizeibehoerde' darf nicht als Empfänger vorkommen (alle Nachrichten ausser 0900008) -->
				<sch:rule context="//tns:nachrichtenkopf/tns:empfaenger/tns:informationen/tns:auswahl_kommunikationspartner">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:polizeibehoerde) = 0) else true()" id="SCH-VSTR-0016">
						[SCH-VSTR-0016] Nachrichtenkopf: Das 'auswahl_kommunikationspartner'-Element 'polizeibehoerde' unter empfaenger/informationen darf nicht vorkommen!
					</sch:assert>
				</sch:rule>
			</sch:pattern>
				
			<sch:pattern>
				<!-- Kardinalitaet: 'finanzbehoerde' darf nicht als Empfänger vorkommen (alle Nachrichten ausser 0900008) -->
				<sch:rule context="//tns:nachrichtenkopf/tns:empfaenger/tns:informationen/tns:auswahl_kommunikationspartner">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (count(tns:finanzbehoerde) = 0) else true()" id="SCH-VSTR-0017">
						[SCH-VSTR-0017] Nachrichtenkopf: Das 'auswahl_kommunikationspartner'-Element 'finanzbehoerde' unter empfaenger/informationen darf nicht vorkommen!
					</sch:assert>
				</sch:rule>
			</sch:pattern>		
		...
		<!-- VSTR - GRUNDDATEN-GESCHAEFTSREGELN: -->
			...
			<sch:pattern id="SCH-VSTR-0062" abstract="true">
				<!-- Kardinalitaet: Die 'auswahl_instanzbehoerde'-Elemente 'beteiligter', 'polizeibehoerde', 'finanzbehoerde' dürfen nicht vorkommen! (alle Nachrichten ausser Nachricht 5 und 8) -->
				<sch:rule context="$pfadNachrichtAlleOhne0508/tns:grunddaten/tns:verfahrensdaten/tns:instanzdaten/tns:auswahl_instanzbehoerde">
					<sch:assert test="count(tns:beteiligter)=0 and count(tns:polizeibehoerde)=0 and count(tns:finanzbehoerde)=0">
						[SCH-VSTR-0062] Grunddaten: Die 'auswahl_instanzbehoerde'-Elemente 'beteiligter', 'polizeibehoerde' und 'finanzbehoerde' dürfen nicht vorkommen!
					</sch:assert>
				</sch:rule>
			</sch:pattern>
		...
		<!-- VSTR - CODELISTEN-GESCHAEFTSREGELN: -->
			...
			<sch:pattern>
				<!-- Eingeschränkte Werte zur Codeliste GDS.Registerart (alle Nachrichten ausser 0900008) -->
				<sch:rule context="//tns:registerart">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then code = ('GnR','GsR','HRA','HRB','PR','VR', 'SR') else true()" id="SCH-VSTR-0535">
						[SCH-VSTR-0535] Codeliste: Der Codelistenschlüssel der Typ1-Codeliste 'GDS.Registerart' zum Element 'registerart' darf nur folgende Werte haben:'GnR','HRA','HRB','PR','VR','GsR' oder 'SR'!
					</sch:assert>
				</sch:rule>
			</sch:pattern>
			...
			<sch:pattern>
				<!-- Eingeschränkte Werteliste zur Codeliste 'Rechtsformen' (XUnternehmen); der verwendete Code beim Element 'rechtsform' (unterhalb von 'angabenZurRechtsform' in 'organisation') darf nicht '681000' oder '682000' sein (alle Nachrichten ausser 0900008) -->
				<sch:rule context="//tns:beteiligung/tns:beteiligter/tns:auswahl_beteiligter/tns:organisation/tns:angabenZurRechtsform/tns:rechtsform">
					<sch:assert test="if (not(ancestor::tns:nachricht.vstr.fehlermeldung.0900008)) then (code != '681000' and code != '682000') else true()" id="SCH-VSTR-0540">
						[SCH-VSTR-0540] Codeliste: Der verwendete Code der Codespalte zur Typ3-Codeliste 'Rechtsformen' (XUnternehmen) beim Element 'rechtsform' 
						(unterhalb von 'angabenZurRechtsform' in 'organisation') darf nicht '681000' oder '682000' enthalten!
					</sch:assert>
				</sch:rule>
			</sch:pattern>
