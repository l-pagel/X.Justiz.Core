...
<!-- 
    ...
    XJustiz-Fachdatensatz xjustiz_3100_musterfeststellungsklagenregister_1_0.xsd
    Version 1.0
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2"
    ...
    <sch:pattern>
        <sch:rule context="tns:nachricht.mfkreg.klagebekanntmachung_terminbestimmung.3100001/tns:grunddaten/tns:verfahrensdaten/tns:auswahl_termin/tns:terminsdaten">
            <sch:extends rule="test.terminsID"/>
        </sch:rule>
        <sch:rule context="tns:nachricht.mfkreg.klagebekanntmachung_terminbestimmung.3100001/tns:grunddaten/tns:verfahrensdaten/tns:auswahl_termin/tns:terminsdaten/tns:auswahl_terminsort/tns:gerichtsort">
            <sch:extends rule="test.anschrift"/>
        </sch:rule>
    </sch:pattern>
